...
$sql="select * from student,queries where queries.usn= student.usn" ;
$res=mysql_query($sql);
...
<body>
<p><a href="queries.php">REFRESH RECORDS</a> </p>
 <table width="567" border="4" class="img" align="center">
<thead style="
    background-color: #40D899;
">
   ...
   {
      ?>
   <tr><td scope="row"><?php echo $row["qid"];?>&nbsp;</td>
     <td scope="row"><?php echo $row["usn"];?>&nbsp;</td>
     <td scope="row"><?php echo $row["stdname"];?>&nbsp;</td>
     <td><?php echo $row["query"];?>&nbsp;</td>
		  	  <td><?php echo $row["status"];?></td>
     <td align="center">
	<a align="center"  href="updatequery.php?qid=<?php echo $row["qid"];?>">
Update Status</a></td>
   </tr>
   </tr>
   <?php
