...
<form method="post" name="login" action="saveevents.php" >
  <table width="460" height="162">
    <tr>
      <h2 class=""> Add Events</h2>
    </tr>
    <tr>
      <td><label for="notifications" class="labelname">Event Name:</label></td>
      <td><input type="textarea" size="40" title="Enter Your User ID Plz..." name="eventname" 
...
onmouseover="style='-moz-box-shadow: 6px 10px 12px #888;
 -webkit-box-shadow: 6px 6px 12px #888;box-shadow:6px 10px 12px #888;'"/></td>
    ...
    <tr> 
	<td><label for="notifications" class="labelname">Event Date:</label></td>
      <td><input type="date"  title="Enter Your User ID Plz..." name="date" 
id="userid" required="required" autocomplete="on" 
onmouseover="style='-moz-box-shadow: 6px 10px 12px #888;
 -webkit-box-shadow: 6px 6px 12px #888;box-shadow:6px 10px 12px #888;'"/></td>
